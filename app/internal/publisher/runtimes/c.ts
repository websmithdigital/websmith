 ...
 * C Runtime Generator
 *
 * Orchestration-only: loads template files from template/c/,
...
const TEMPLATE_DIR = path.resolve(process.cwd(), 'app', 'internal', 'publisher', 'template', 'c');
